class PlanetInfo {
  ...
  final String varlist1;
  final String variety2;
  final String varlist2;
...
List<PlanetInfo> planets = [
  PlanetInfo(1,
      name: 'Jute',
      location:'Crops Information',
      iconImage: 'assets/clg/ag/ag4.jpg',
      description:
      ...
      images: [
        'assets/clg/ag/ag1.jpg',
        'assets/clg/ag/ag2.jpg',
       'assets/clg/ag/ag3.jpg',
       'assets/clg/ag/ag4.jpg',
      ],
      cou: "Jute Specifications",
  ...
  PlanetInfo(2,
      name: 'Wheat',
      location:'Crops Information',
      iconImage: 'assets/clg/va/va3.jpg',
      description:
      ...
      images: [
       'assets/clg/va/va1.jpg',
       'assets/clg/va/va2.jpg',
       'assets/clg/va/va3.jpg',
       'assets/clg/va/va4.jpg',
      ],
      cou: "Wheat Specifications",
  subname:"wheat crop cultivationn",
      ...
      sto:" Storage:",
      sto1:"The grains should be thoroughly dried before storage. The storage life of the grains should be 6 months.",
  ),
  PlanetInfo(3,
      name: 'Rice',
      location: 'Crops Informatons',
      iconImage: 'assets/clg/ad/ad4.jpg',
      description:
      ...
      images: [
       'assets/clg/ad/ad1.jpg',
       'assets/clg/ad/ad2.jpg',
       'assets/clg/ad/ad3.jpg',
       'assets/clg/ad/ad4.jpg',
      ],
    cou: "Rice Specifications",
  ...
  PlanetInfo(4,
      name: 'Sugarcane',
      location: ' Crops Information',
      iconImage: 'assets/clg/ac/ac2.jpg',
      description:
          "Sugarcane is a tropical, perennial grass that forms lateral shoots at the base to produce multiple stems, typically 3 to 4 m (10 to 13 ft) high and about 5 cm (2 in) in diameter. The stems grow into cane stalk which, when mature, constitutes around 75% of the entire plant. A mature stalk is typically composed of 11–16% fiber, 12–16% soluble sugars, 2–3% non-sugars, and 63–73% water. ",
      images: [
        'assets/clg/ac/ac1.jpg',
        'assets/clg/ac/ac2.jpg',
        'assets/clg/ac/ac3.jpg',
        'assets/clg/ac/ac4.jpg',
      ],
   cou: "Sugarcane Specifications",
  ...
  PlanetInfo(5,
      name: 'Cotton',
      location: 'Crops Information',
      iconImage: 'assets/clg/ca/ca2.jpg',
      ...
      images: [
        'assets/clg/ca/ca1.jpg',
        'assets/clg/ca/ca2.jpg',
        'assets/clg/ca/ca3.jpg',
        'assets/clg/ca/ca4.jpg',
      ],
     cou: "Cotton Specifications",
  ...
  PlanetInfo(6,
      name: 'Ragi',
      location:'Crops Information',
      iconImage: 'assets/clg/fc/fc2.jpg',
      description:
          "The Forest College and Research Institute (FC & RI) is located at Mettupalayam in the sylvan surroundings of Jakanari Reserved Forest, about 40 km north of Tamil Nadu Agricultural University (TNAU) main campus, Coimbatore. It is  located of the foothills of Nilgiris on the Kotagiri road.The Forest College and Research Institute (FC & RI) is located at Mettupalayam in the sylvan surroundings of Jakanari Reserved Forest, about 40 km north of Tamil Nadu Agricultural University (TNAU) main campus, Coimbatore. ",
      images: [
        'assets/clg/fc/fc1.jpg',
        'assets/clg/fc/fc2.jpg',
        'assets/clg/fc/fc3.jpg',
        'assets/clg/fc/fc4.jpg',
      ],
    cou: "Ragi Specificaions",
  ...
  PlanetInfo(7,
      name: 'Maize',
      location: 'Crops Information',
      iconImage: 'assets/clg/ja/ja2.jpg',
      description:
      ...
      images: [
        'assets/clg/ja/ja1.jpg',
        'assets/clg/ja/ja2.jpg',
        'assets/clg/ja/ja3.jpg',
        'assets/clg/ja/ja4.jpg',
      ],
   cou: "Maize Specifications",
  ...
  PlanetInfo(8,
      name: 'Rupper',
      location: 'Crops Information',
      iconImage: 'assets/clg/ra/ra2.jpg',
      description: "The rubber tree starts bearing fruit at four years of age. Each fruit contains three or four seeds, which fall to the ground when the fruit ripens and splits. The seed consists of a thin hard shell and a kernel containing oil used in various industries. The kernel and the shell are sometimes extracted together, yielding an undecorticated oilcake or meal with a very high fibre content. There is a great difference in feeding value between decorticated and undecorticated meal. The oil can either be expressed (hot or cold) or extracted.",
      images: [
        'assets/clg/ra/ra1.jpg',
        'assets/clg/ra/ra2.jpg',
        'assets/clg/ra/ra3.jpg',
        'assets/clg/ra/ra4.jpg',
      ],
   cou: "Rupper Specifications",
   ...
   PlanetInfo(9,
      name: 'Groundnut',
      location: 'Crops Information',
      iconImage: 'assets/clg/ga/ga1.jpg',
      description: "The peanut, also known as the groundnut, is a legume crop grown mainly for its edible seeds. It is widely grown in the tropics and subtropics, being important to both small and large commercial producers. It is classified as both a grain legume and, due to its high oil content, an oil crop.World annual production of shelled peanuts was 44 million tonnes in 2016, led by China with 38% of the world total. Atypically among legume crop plants, peanut pods develop underground rather than above ground.",
      images: [
        'assets/clg/ga/ga1.jpg',
        'assets/clg/ga/ga2.jpg',
        'assets/clg/ga/ga3.jpg',
        'assets/clg/ga/ga4.jpg',
      ],
   cou: "Groundnut Specifications",
    ...
    PlanetInfo(10,
      name: 'CashewNut',
      location: 'Crops Information',
      iconImage: 'assets/clg/gaa/gaa1.jpg',
      description: "The cashew tree originates from Brazil, occurring naturally on Caatinga, Cerrados and Amazonian biomes. Nowadays, the cashew tree is grown around the world especially in Brazil, Vietnam, India, Nigeria, Indonesia, Philippines, Benin, Guinea-Bissau, and the Ivory Coast. It belongs to Anacardiaceae family and the genera Anacardium has approximately 22 species;.The cashew tree is evergreen with different sizes, but usually, it is 8–15 m height. The real fruit from cashew tree is the nut, a brown, reniform achene composed of the pericarp (shell) and the almond.",
      images: [
        'assets/clg/gaa/gaa1.jpg',
        'assets/clg/gaa/gaa2.jpg',
        'assets/clg/gaa/gaa3.jpg',
        'assets/clg/gaa/gaa4.jpg',
      ],
   cou: "Cashewnut Specifications",
